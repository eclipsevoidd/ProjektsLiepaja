...
var _r = clamp(radius_pos + _w, _ctrl.CIETUMS_r_inner + 20, _ctrl.CIETUMS_r_outer - 20);

x = _ctrl.CIETUMS_cx + lengthdir_x(_r, angle_pos);
y = _ctrl.CIETUMS_cy + lengthdir_y(_r, angle_pos);