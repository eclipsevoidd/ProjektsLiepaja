...
if (state == GS.MENU) {
    ...
    draw_text_transformed(_w / 2, _h / 2 - 100, "ZIEMEĻU FORTI", 1, 1, 0);
...
draw_set_font(f_FranklinGothicLarge)
draw_text_transformed(_w - 45, 18, string(score_val), .85, .85, 0);
draw_set_color(c_ltgray);
draw_set_font(f_FranklinGothicMedLarge)
draw_text(_w - 45, 50, "PUNKTI");
...
if (state == GS.PLAYING || state == GS.INTRO) {
    ...
    draw_text_transformed(_w/2, 25, _ts, 1, 1, 0);
